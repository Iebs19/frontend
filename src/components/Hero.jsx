...
import Banner from '../assets/AI_GenAI.png'
  ...
  return (
    <div className="bg-transparent">
      <TextParallaxContent
        imgUrl={Banner}
        subheading="InsiMine"
        heading="Mining Insights for Data Driven Success"
      >
        <ExampleContent />
      </TextParallaxContent>
      {/* <TextParallaxContent
...
const ExampleContent = () => (
  <div className="mx-auto grid max-w-full grid-cols-1 gap-8 px-4 pb-24 pt-12 md:grid-cols-12 backdrop-blur-md">
    <h2 className="col-span-1 text-5xl font-bold md:col-span-4 self-center text-darkBlue">
      Who are we ?
    </h2>
